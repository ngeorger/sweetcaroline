...
var config1 = {
    "id": jQuery('.tt-tweets').attr('data-widget-user'),
    "domId": 'tt-show-tweets',
    "maxTweets": 5,
    "enableLinks": false
};
...
var configLikes = {
  "profile": {"screenName": jQuery('.tt-tweets').attr('data-widget-user')},
  "domId": 'tt-show-tweets',
  "maxTweets": jQuery('.tt-tweets').attr('data-widget-num'),
  "enableLinks": true,
  "showUser": false,
  "showTime": true,
  "showImages": false,
